...
URLS=[
 BASE+"/venta/lotes-o-terrenos/santa-cruz/m2-desde-400/totales",
 BASE+"/venta/lotes-o-terrenos/santa-cruz/norte/m2-desde-400/totales",
 BASE+"/venta/lotes-o-terrenos/santa-cruz/m2-desde-400/m2-hasta-900/totales",
]
...
def collect(rate=7.0):
    ...
    for page_url in URLS:
      r=requests.get(page_url,timeout=25,headers={"User-Agent":"RadarSCZ-personal/0.1"})
      if r.status_code in (403,429): break
      r.raise_for_status(); soup=BeautifulSoup(r.text,"html.parser")
      # InfoCasas puede cambiar su HTML; tomamos contenedores con precio + m².
